...
$user_name = isset($_SESSION['user']['name']) ? $_SESSION['user']['name'] : null;
$user_count = "SELECT count FROM user WHERE name = '".$user_name."'";

$balance_query = mysqli_query($db_connection, "SELECT count FROM user WHERE name='".$user_name."'");
$balance = mysqli_fetch_array($balance_query, MYSQLI_ASSOC)["count"];
